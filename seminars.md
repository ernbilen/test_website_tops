...
{% elsif (speaker.Presenter == 'Jamie Hartman-Boyce') or (speaker.Presenter == 'Alex Liber') or (speaker.Presenter == 'Aryn Phillips') %}
<tr>
...
{% elsif (speaker.Presenter == 'Robert West') or (speaker.Presenter == 'Abigail S. Friedman') or (speaker.Presenter == 'Bo Feng') or (speaker.Presenter == 'Rizki Siregar') or (speaker.Presenter == 'Dan Sacks') %}
<tr>
