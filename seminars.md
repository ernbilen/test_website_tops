...
{% elsif (speaker.Presenter == 'Leontine Goldzahl') or (speaker.Presenter == 'Robert West') or (speaker.Presenter == 'Abigail S. Friedman') or (speaker.Presenter == 'Bo Feng') or (speaker.Presenter == 'Rizki Siregar') or (speaker.Presenter == 'Dan Sacks') or (speaker.Presenter == 'Lauren Hoehn-Velasco') %}
<tr>
